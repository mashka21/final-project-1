                                            ...
                                            <ul class="sclist">
                                                @foreach ($category->subCategories as $scategory)
                                                    <li>
                                                        ...
                                                        <a href="#" onclick="confirm('Are you sure to delete this sub-category?') || event.stopImmediatePropagation()" wire:click.prevent="deleteSubCategory({{$scategory->id}})" class="slink">
