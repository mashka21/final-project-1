									...
									@foreach ($lproducts as $lproduct)
										<div class="product product-style-2 equal-elem ">
											<div class="product-thumnail">
												...
												@if ($lproduct->id == 1 || $lproduct->id == 6 )
													<div class="group-flash">
														<span class="flash-item new-label">new</span>
														<span class="flash-item bestseller-label">Bestseller</span>
													</div>
												@elseif ($lproduct->id % 2 == 0 && $lproduct->id != 2)
													<div class="group-flash">
														<span class="flash-item new-label">new</span>
													</div>
												@else
					...
					<div class="wrap-product-tab tab-style-1">
						<div class="tab-control">
							@foreach ($categories as $key=>$category)
								<a href="#category_{{$category->id}}" class="tab-control-item {{$key==0 ? 'activa':''}}">Smartphone</a>
							@endforeach
						</div>
						<div class="tab-contents">

							<div class="tab-content-item {{$key==0 ? 'activa':''}}" id="category_{{$category->id}}">
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
									@foreach ($categories as $category)
									@php
										$c_products = DB::tab;e('products')->where('category_id',$category->id)->get()->take($no_of_products);
									@endphp
