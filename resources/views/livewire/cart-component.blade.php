<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
                        ...
                        <div class="summary-item">
                            <form wire:submit.prevent = "applyCouponCode">
                                ...
                                @if(session::has('coupon_message'))
                                    <div class="alert alert-success" role="alert">{{session::get('coupon_message')}}</div>                                    
                                @endif
                                <p class="row-in-form">
            ...
            <div class="wrap-iten-in-cart">
                <h3 class="title-box" style="border-bottom: 1px solid; padding-bottom:15px;">{{Cart::instance('saveForLater')->count()}} item(s) Save For Later</h2>
